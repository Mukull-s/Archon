...
export default function ScrollStorySection() {
  ...
  const termLinesRef = useRef([]) // [stepIndex][lineIndex]
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      STEPS.forEach((step, i) => {
        ...
        // ── Terminal lines stream in one by one ──
        ...
        if (i < N - 1) {
          ...
          lines.forEach((line) => {
            if (line) tl.to(line, { opacity: 0, y: -8, duration: 0.08 }, '<')
          })
        }
      })
    ...
    <section id="how-it-works" ref={sectionRef} style={{ position: 'relative' }}>
      ...
      >
        ...
        <div style={{
          ...
          background: `
            radial-gradient(ellipse 70% 50% at 25% 50%, rgba(109,40,217,0.04) 0%, transparent 60%),
            radial-gradient(ellipse 50% 40% at 75% 50%, rgba(176,38,255,0.025) 0%, transparent 60%)
          `,
        }} />
            ...
            <div style={{ position: 'relative', paddingLeft: '20px' }}>
              {STEPS.map((step, i) => (
                <div
                  ...
                  style={{
                    opacity: i === 0 ? 1 : 0.12,
                    transform: i === 0 ? 'translateX(0)' : 'translateX(-6px)',
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      position: 'absolute', left: '-18px', top: '16px', bottom: '16px',
                  ...
                  <div>
                    <div style={{
                      ...
                      fontWeight: 600, color: 'var(--accent-light)', opacity: 0.5, marginBottom: '2px',
                    }}>
                      Step {step.num}
                    </div>
                    <div style={{
                      fontSize: '15px', fontWeight: 700, color: '#fff',
                      letterSpacing: '-0.02em', marginBottom: '3px', lineHeight: 1.3,
                    }}>
                      {step.title}
                    </div>
                    <div style={{
                ...
                {STEPS.map((step, si) => (
                  <div
                    ...
                    style={{
                      ...
                      top: si === 0 ? undefined : '18px',
                      left: si === 0 ? undefined : '16px',
                    ...
                    {step.lines.map((line, li) => (
                      <div
                        ...
                        style={{
                          ...
                          lineHeight: 1.85, color: line.color || '#B8B1C7',
                          opacity: si === 0 ? 1 : 0,
          ...
          {STEPS.map((_, i) => (
            <div
              ...
              style={{
                ...
                transform: i === 0 ? 'scale(1.4)' : 'scale(0.5)',
                opacity: i === 0 ? 1 : 0.15,
              }}
            />
          ))}
